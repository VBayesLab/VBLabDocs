...
3. Check API reference for [supported VB techniques]({% link Variational-Bayes.md%}), [statistical models]({% link Model.md%}) and [how to define custom models]({% link Model-Custom.md%}) for users' applications.  
